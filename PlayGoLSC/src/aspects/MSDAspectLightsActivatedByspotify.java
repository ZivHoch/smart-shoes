//  The file MSDAspectLightsActivatedByspotify.aj was automatically generated using S2A .
...
public class MSDAspectLightsActivatedByspotify extends MSDAspect implements MSDSubscribe, Serializable
{


	//Constants for instances, locations and variables
	static final int shoesConnectedToSpotify_INST_shoesConnectedToSpotify = 0;
	static final int RGBMode_INST_rGBMode = 1;


	static final int long_var_symbolic_Timer = 0;

	private final String niceName = "LightsActivatedByspotify";

	public MSDAspectLightsActivatedByspotify()
	{
		this(null);	}

	public MSDAspectLightsActivatedByspotify(PlaygoCoordinator coordinator)
	{
		super(coordinator);
		subscribe();
		...
		addMinimalEvent(MSDMethods.shoesConnectedToSpotify_shoesConnectedToSpotify_musicPlaying);
		setHotCut(2,1);
		setLastCut(2,2);
		numberOfLifeLines = 2;
		numberOfInstances = 2;
			...
			MSDMethodSet CV,MSDMethodSet HV,ActiveMSDAspect activeMSD)
	{
		...
		MSDMethod MSDm91 = new MSDMethod(rGBMode,rGBMode,
			MSDMethods.RGBMode_RGBMode_RGBOn,null,"RGBMode:RGBMode:RGBOn",niceName,activeMSD.getGlobalId());// RGBOn() Execute
		MSDMethod MSDm92 = new MSDMethod(shoesConnectedToSpotify,shoesConnectedToSpotify,
			MSDMethods.shoesConnectedToSpotify_shoesConnectedToSpotify_musicPlaying,null,"shoesConnectedToSpotify:shoesConnectedToSpotify:musicPlaying",niceName,activeMSD.getGlobalId());// musicPlaying() Monitored
