 ...
 * 
 */
public class ShockabserverSurfaceModeGenerated
    extends SMBaseClass
{
    ...
    public ShockabserverSurfaceModeGenerated(java.lang.String name, il.ac.wis.cs.s2a.runtime.lib.PlaygoCoordinator playgoCoordinator) {
        super(name);
        setCoordinator(playgoCoordinator);
        oneTimeInit();
    }

    public ShockabserverSurfaceModeGenerated(java.lang.String name, boolean init, Object playgoCoordinator) {
        super(name);
    ...
    public void setStatus(String arg0) {
        ...
        playgo.systemmodel.SystemModelMain.getInstance().getPlayable().
        	setPropertyValue("ShockabserverSurfaceMode", name, "status", arg0);
         
        il.ac.wis.cs.playgo.playtoolkit.api.impl.java.SystemModelAgent.getInstance()
        	.setPropertyValue("ShockabserverSurfaceMode", name, "status", arg0);
        
		//ExecutionBridge handling
        SystemModelMain.getInstance().setPropertyValue(("ShockabserverSurfaceMode"), (name), ("status"), ("String"), (String.valueOf(arg0)));
